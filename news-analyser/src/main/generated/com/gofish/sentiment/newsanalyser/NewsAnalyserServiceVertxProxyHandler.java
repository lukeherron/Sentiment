...
public class NewsAnalyserServiceVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final NewsAnalyserService service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public NewsAnalyserServiceVertxProxyHandler(Vertx vertx, NewsAnalyserService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public NewsAnalyserServiceVertxProxyHandler(Vertx vertx, NewsAnalyserService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public NewsAnalyserServiceVertxProxyHandler(Vertx vertx, NewsAnalyserService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
