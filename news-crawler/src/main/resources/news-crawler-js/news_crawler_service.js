...
var JNewsCrawlerService = com.gofish.sentiment.newscrawler.NewsCrawlerService;
...
NewsCrawlerService.create = function(vertx, config) {
  ...
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
    return utils.convReturnVertxGen(JNewsCrawlerService["create(io.vertx.core.Vertx,io.vertx.core.json.JsonObject)"](vertx._jdel, utils.convParamJsonObject(config)), NewsCrawlerService);
  } else throw new TypeError('function invoked with invalid arguments');
};
...
NewsCrawlerService.createProxy = function(vertx, address) {
  ...
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string') {
    return utils.convReturnVertxGen(JNewsCrawlerService["createProxy(io.vertx.core.Vertx,java.lang.String)"](vertx._jdel, address), NewsCrawlerService);
  } else throw new TypeError('function invoked with invalid arguments');
};
