...
var JNewsLinkerService = com.gofish.sentiment.newslinker.NewsLinkerService;
...
NewsLinkerService.create = function(vertx, config) {
  ...
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
    return utils.convReturnVertxGen(JNewsLinkerService["create(io.vertx.core.Vertx,io.vertx.core.json.JsonObject)"](vertx._jdel, utils.convParamJsonObject(config)), NewsLinkerService);
  } else throw new TypeError('function invoked with invalid arguments');
};
...
NewsLinkerService.createProxy = function(vertx, address) {
  ...
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string') {
    return utils.convReturnVertxGen(JNewsLinkerService["createProxy(io.vertx.core.Vertx,java.lang.String)"](vertx._jdel, address), NewsLinkerService);
  } else throw new TypeError('function invoked with invalid arguments');
};
