...
public class NewsLinkerServiceVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final NewsLinkerService service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public NewsLinkerServiceVertxProxyHandler(Vertx vertx, NewsLinkerService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public NewsLinkerServiceVertxProxyHandler(Vertx vertx, NewsLinkerService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public NewsLinkerServiceVertxProxyHandler(Vertx vertx, NewsLinkerService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
