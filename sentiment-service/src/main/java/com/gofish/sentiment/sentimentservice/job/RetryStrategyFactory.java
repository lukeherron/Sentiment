...
public class RetryStrategyFactory {
    ...
    private static void calculateFromReplyException(Job job, ReplyException replyException) {
        switch (replyException.failureType()) {
            ...
            case RECIPIENT_FAILURE:
                ...
                catch (DecodeException e) { // We have an error that was not generated by us. Handle accordingly
                    processGeneralError(job, new JsonObject().put("error", replyException.getMessage()), replyException.getMessage());
                }
                break;
            default:
    ...
    private static void processErrorMessage(Job job, JsonObject errorMessage) {
        ...
        switch (statusCode) {
            ...
            case 0: // Method parameter 'errorMessage' is not a valid json object
                processGeneralError(job, errorMessage, "Encountered invalid error message in RetryStrategy#processErrorMessage()");
                break;
            default:
                processGeneralError(job, errorMessage, "Encountered unhandled statusCode in RetryStrategy#processErrorMessage():" + statusCode);
        }
    }
    ...
    private static void processGeneralError(Job job, JsonObject errorMessage, String logMessage) {
