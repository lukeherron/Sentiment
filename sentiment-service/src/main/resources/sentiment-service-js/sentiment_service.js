...
var JSentimentService = com.gofish.sentiment.sentimentservice.SentimentService;
...
SentimentService.create = function(vertx, config) {
  ...
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
    return utils.convReturnVertxGen(JSentimentService["create(io.vertx.core.Vertx,io.vertx.core.json.JsonObject)"](vertx._jdel, utils.convParamJsonObject(config)), SentimentService);
  } else throw new TypeError('function invoked with invalid arguments');
};
...
SentimentService.createProxy = function(vertx, address) {
  ...
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string') {
    return utils.convReturnVertxGen(JSentimentService["createProxy(io.vertx.core.Vertx,java.lang.String)"](vertx._jdel, address), SentimentService);
  } else throw new TypeError('function invoked with invalid arguments');
};
