...
public class SentimentServiceVertxEBProxy implements SentimentService {
  ...
  public SentimentServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public SentimentServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public SentimentService getSentiment(String query, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _deliveryOptions.addHeader("action", "getSentiment");
  ...
  public SentimentService analyseSentiment(String query, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _json.put("query", query);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "analyseSentiment");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
