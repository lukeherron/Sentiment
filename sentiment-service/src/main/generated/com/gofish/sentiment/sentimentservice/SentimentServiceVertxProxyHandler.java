...
public class SentimentServiceVertxProxyHandler extends ProxyHandler {
  ...
  public SentimentServiceVertxProxyHandler(Vertx vertx, SentimentService service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public SentimentServiceVertxProxyHandler(Vertx vertx, SentimentService service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public SentimentServiceVertxProxyHandler(Vertx vertx, SentimentService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
